<div class="nav-wrap">
	...
	<div class="dropdown status-tooltip" style="height: 20px;display: inline-block;position: absolute; margin-left: -10px; margin-top: 25px;">
		...
		<div class="dropdown-content">
			...
			<ul class="drop-vape">
				<li><a href="/staff.html" title="Команда проекта">Команда проекта</a></li>
				<li><a href="/issue_tracker.html" title="Команда проекта">Баг-репорт</a></li>
				<li><a href="/banlist.html" title="Бан-лист">Бан-лист</a></li>
				<li><a href="/jobs.html" title="Список работ">Работы</a></li>
				<li><a href="/clans.html" title="Гайд о кланах"><span>Кланы</span></a></li>
				<li><a href="/economy.html" title="Экономика"><span>Экономика</span></a></li>
				<li><a href="/pet.html" title="Всё о питомцых"><span>Питомцы</span></a></li>
			</ul>
		</div>
	</div>
...
<div class="riglt-floats-xs">
    [group=5]
		<a href="/index.php?do=register" class="btn-drop pulse" title="Перейти на страницу регистрации" style="width: 270px;">
			<i class="far fa-user btn-icon" style="margin-top: 15px;"></i> Регистрация
		</a>
	[/group]
    [not-group=5]
		<a href="/download.html" class="btn-drop pulse" title="Скачать лаунчер" style="width: 270px; background: linear-gradient(to right, #42a4f3, #5260d5);">
			<i class="fas fa-download btn-icon" style="margin-top: 15px;"></i></span> Скачать лаунчер
		</a>
	[/not-group]
</div>